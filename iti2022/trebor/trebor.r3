...
:main
	...
	bfont1 
	|SDLfull
	"r3/iti2022/trebor/mapatrebor.png" loadimg 'sfondo ! 
	
	"r3/iti2022/trebor/inicio.jpg" loadimg 'sinicio !
	"r3/iti2022/trebor/fin.png" loadimg 'sfin !

	32 32 "r3\iti2022\trebor\treborj.png" tsload 'sprj !
	50 50 "r3\iti2022\trebor\enemigos.png" tsload 'spre !
	"r3\iti2022\trebor\nivel.map" loadtilemap 'mapajuego !
	
	"r3\iti2022\trebor\btnj1.png" loadimg 'sbtnj1 !		
	"r3\iti2022\trebor\btnj2.png" loadimg 'sbtnj2 !		
	"r3\iti2022\trebor\btns1.png" loadimg 'sbtns1 !		
	"r3\iti2022\trebor\btns2.png" loadimg 'sbtns2 !		
	'menu SDLshow
	SDLquit ;	
