...
:loadsndfile
	SNDInit
	"r3/iti2022/vialbot/audio/musica-ini.mp3" Mix_LoadMUS 'musicini !
	"r3/iti2022/vialbot/audio/musica-run.mp3" Mix_LoadMUS 'musicrun !
	"r3/iti2022/vialbot/audio/musica-end.mp3" Mix_LoadMUS 'musicend !

	'sndlist >a
	'sndfile ( dup c@ 1? drop
		dup "r3/iti2022/vialbot/audio/%s" sprint
		Mix_LoadWAV a!+
		>>0 ) drop ;
...
:main
	...
	"r3\iti2022\vialbot\img\mapa.png" loadimg 'mapajuego !
	
	128 128 "r3\iti2022\vialbot\img\autos.png" tsload 'sprauto !
	64 64 "r3\iti2022\vialbot\img\robot.png" tsload 'sprplayer !
	96 96 "r3\iti2022\vialbot\img\semaforo.png" tsload 'sprsemaforo !
	38 31 "r3\iti2022\vialbot\img\vida.png" tsload 'sprvida !
	"r3\iti2022\vialbot\img\base1.png" loadimg 'base1 !
	"r3\iti2022\vialbot\img\base2.png" loadimg 'base2 !
	
	"r3\iti2022\vialbot\img\inicio.png" loadimg 'imginicio !
	"r3\iti2022\vialbot\img\menu.png" loadimg 'imgmenu !
	
	"r3\iti2022\vialbot\img\gameover.png" loadimg 'imggover !	
	"r3\iti2022\vialbot\img\fondofin.png" loadimg 'imgfin !
	
	"r3\iti2022\vialbot\img\btns.png" loadimg 'imgbtns !
	"r3\iti2022\vialbot\img\btnsd.png" loadimg 'imgbtnsd !
	"r3\iti2022\vialbot\img\btne.png" loadimg 'imgbtne !
	"r3\iti2022\vialbot\img\btned.png" loadimg 'imgbtned !

	"r3\iti2022\vialbot\img\cursor.png" loadimg 'scursor !	

	ttf_init	
	"r3/iti2022/vialbot/font/PressStart2P-Regular.ttf" 40 TTF_OpenFont 'font !	
	"r3/iti2022/vialbot/font/PressStart2P-Regular.ttf" 30 TTF_OpenFont 'font2 !	
