...
:main
	...
	bfont1 
	|SDLfull
	32 32 "r3\iti2022\jetpack\img\jetpack.png" tsload 'sprplayer !
	"r3\iti2022\jetpack\mapa.map" loadtilemap 'mapajuego !
	
	"r3\iti2022\jetpack\img\inicio.png" loadimg 'sinicio !		
	"r3\iti2022\jetpack\img\ganaste.png" loadimg 'sganaste !		
	"r3\iti2022\jetpack\img\perdiste.png" loadimg 'sperdiste !		

	"r3\iti2022\jetpack\img\btnp1.png" loadimg 'sbtnj1 !		
	"r3\iti2022\jetpack\img\btnp2.png" loadimg 'sbtnj2 !		
	"r3\iti2022\jetpack\img\btns1.png" loadimg 'sbtns1 !		
	"r3\iti2022\jetpack\img\btns2.png" loadimg 'sbtns2 !			
