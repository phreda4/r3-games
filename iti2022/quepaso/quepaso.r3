...
:loadsndfile
	"r3/iti2022/quepaso/audio/musinicio.mp3" Mix_LoadMUS 'musicini !
	"r3/iti2022/quepaso/audio/musjuego.mp3" Mix_LoadMUS 'musicrun !

	'sndlist >a
	'sndfile ( dup c@ 1? drop
		dup "r3/iti2022/quepaso/audio/%s" sprint
		Mix_LoadWAV a!+
		>>0 ) 2drop ;
...
:inicio
	ttf_init
	"r3/iti2022/quepaso/font/RobotoCondensed-Bold.ttf" 40 TTF_OpenFont 'fontt !	
	"r3/iti2022/quepaso/font/RobotoCondensed-Regular.ttf" 24 TTF_OpenFont 'font !	
	
	"r3/iti2022/quepaso/img/cursor.png" loadimg 'scursor !	
	"r3/iti2022/quepaso/img/tablero.png" loadimg 'stablero !
	"r3/iti2022/quepaso/img/fin.png" loadimg 'sfin !
	"r3/iti2022/quepaso/img/podio.png" loadimg 'spodio !
	"r3/iti2022/quepaso/img/inicio.png" loadimg 'sinicio !
	
	"r3/iti2022/quepaso/img/ficha1.png" loadimg 'sf1 !
	"r3/iti2022/quepaso/img/ficha2.png" loadimg 'sf2 !
	"r3/iti2022/quepaso/img/ficha3.png" loadimg 'sf3 !
	
	"r3/iti2022/quepaso/img/turno1.png" loadimg 'tu1 !
	"r3/iti2022/quepaso/img/turno2.png" loadimg 'tu2 !
	"r3/iti2022/quepaso/img/turno3.png" loadimg 'tu3 !

	"r3/iti2022/quepaso/img/btn1.png" loadimg 'sbtn1 !
	"r3/iti2022/quepaso/img/btn2.png" loadimg 'sbtn2 !

	"r3/iti2022/quepaso/img/btnj1.png" loadimg 'sbtnj1 !
	"r3/iti2022/quepaso/img/btnj2.png" loadimg 'sbtnj2 !

	"r3/iti2022/quepaso/img/btns1.png" loadimg 'sbtns1 !
	"r3/iti2022/quepaso/img/btns2.png" loadimg 'sbtns2 !
	
	SNDInit
	loadsndfile
	
	here dup 'preguntas !
	"r3/iti2022/quepaso/preguntas.txt" load 
	0 swap !+ 'here !
